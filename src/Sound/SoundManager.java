...
public class SoundManager extends ThreadPool {
    ...
    public Sound getSound(String filename) { return getSound(getAudioInputStream(filename)); }

    // Loads a Sound from an input stream. Returns null if an error occurs.
    public Sound getSound(InputStream is) { return getSound(getAudioInputStream(is)); }
    ...
    public InputStream play(Sound sound) { return play(sound, null, false); }
    ...
    public InputStream play(InputStream is) { return play(is, null); }
