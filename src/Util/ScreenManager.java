...
public class ScreenManager {
    ...
    public DisplayMode findFirstCompatibleMode(DisplayMode modes[]) {
        ...
        for (DisplayMode mode : modes) {
            ...
            for (DisplayMode goodMode : goodModes) {
                ...
                if (displayModesMatch(mode, goodMode)) { return mode; }
            }
        }
        return null;
    }
    ...
    public boolean displayModesMatch(DisplayMode mode1, DisplayMode mode2) {
        ...
        /*
         Determines if two display modes "match". Two display modes match if
         they have the same resolution, bit depth, and refresh rate. The bit
         depth is ignored if one of the modes has a bit depth of DisplayMode.
         BIT_DEPTH_MULTI. Likewise, the refresh rate is ignored if one of the
    ...
    public Graphics2D getGraphics() {
        ...
        /*
         Gets the graphics context for the display. The ScreenManager uses double buffering,
         so applications must call update() to show any graphics drawn. The application must
