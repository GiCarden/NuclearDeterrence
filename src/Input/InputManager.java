...
public class InputManager implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    */
    ...
    public void clearAllMaps() {
        ...
        for (int i=0; i<keyActions.length; i++) { keyActions[i] = null; }

        for (int i=0; i<mouseActions.length; i++) { mouseActions[i] = null; }
    }
    ...
    public List getMaps(GameAction gameCode) {
        ...
        for (int i=0; i<mouseActions.length; i++) {
            ...
            if (mouseActions[i] == gameCode) { list.add(getMouseName(i)); }
        }
    ...
    public void resetAllGameActions() {
        ...
        for (int i=0; i<mouseActions.length; i++) {
            ...
            if (mouseActions[i] != null) { mouseActions[i].reset(); }
        }
    }
